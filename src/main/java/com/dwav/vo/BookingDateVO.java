...
public class BookingDateVO {
	...
	public String getReserv_date() {
		return reserv_date.replace(" 0000-00-00", "");
	}



	public void setReserv_date(String reserv_date) {
		this.reserv_date = reserv_date.replace(" 0000-00-00", "");
	}
	...
	public BookingDateVO(int accom_id, String reserv_date, int reserv_id) {
		super();
		this.accom_id = accom_id;
